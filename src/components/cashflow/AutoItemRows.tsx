  ...
  return (
    <div className="px-4 py-3 flex items-center justify-between bg-rose-50/50">
      <div>
        ...
        <span className="ml-2 px-1 py-0.5 bg-rose-100 text-rose-600 text-[9px] font-bold rounded uppercase animate-pulse">Auto</span>
      </div>
  ...
  return (
    <div className="px-4 py-3 flex items-center justify-between bg-emerald-50/50">
      <div>
        ...
        <span className="ml-2 px-1 py-0.5 bg-emerald-100 text-emerald-500 text-[9px] font-bold rounded uppercase animate-pulse">Auto</span>
      </div>
  ...
  return (
    <>
      {active.map((loan: LoanItem) => (
        <div key={loan.id} className="px-4 py-3 flex items-center justify-between bg-emerald-50/30">
          <div>
